    ...
    for (m in 1:M) {
      ...
      if (has_assoc[1,m]  == 1 || // etavalue
        ...
        if (has_assoc[1,m] == 1) { // etavalue
          ...
          mark = mark + 1;
  	      e_eta_q = e_eta_q + e_alpha[mark] * val;
        }	
    ...
    //-----  shared random effects
  	...
  	if (sum_size_which_b > 0) {
  	  int mark_beg;  // used to define segment of e_alpha
  	  int mark_end;
      ...
      mark_beg = mark + 1;	  
  	  ...
  	  e_eta_q = e_eta_q + x_assoc_shared_b * e_alpha[mark_beg:mark_end];
      ...
      mark_beg = mark + 1;	  
  	  ...
  	  e_eta_q = e_eta_q + x_assoc_shared_coef * e_alpha[mark_beg:mark_end];
